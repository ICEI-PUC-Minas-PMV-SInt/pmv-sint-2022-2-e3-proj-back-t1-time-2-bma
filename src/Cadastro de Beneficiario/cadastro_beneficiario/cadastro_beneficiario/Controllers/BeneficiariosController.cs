...
namespace cadastro_beneficiario.Controllers
{
    public class BeneficiariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Beneficiario,CPF,Nome_Beneficiario,Situacao,Data_Nascimento,CEP,Logradouro,Numero,Complemento,Cidade,UF")] Beneficiario beneficiario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Beneficiario,CPF,Nome_Beneficiario,Situacao,Data_Nascimento,CEP,Logradouro,Numero,Complemento,Cidade,UF")] Beneficiario beneficiario)
        {
